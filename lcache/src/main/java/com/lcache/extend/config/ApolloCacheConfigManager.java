 ...
 * @author JerryLong
 * @version V1.0
 * @Title: ApolloCacheConfigManager
 * @Description: 获取缓存DB配置，应该有统一抽象类，此为Apollo方式的实现，TODO 使用者实现
 * @date 2021/1/28 9:01 PM
 */
public abstract class ApolloCacheConfigManager extends AbstractConfigManager {

    private static final Logger LOGGER = LoggerFactory.getLogger(ApolloCacheConfigManager.class);
